...
def csv_NYSE(tframes=None, csvdir=None):
    """
    ...
    return csv_NYSEBundle(tframes, csvdir).ingest


class csv_NYSEBundle:
    """
...
@bundles.register("csv_NYSE")
def csv_NYSE_bundle(environ,
                  asset_db_writer,
                  minute_bar_writer,
                  daily_bar_writer,
                  adjustment_writer,
