...
def csv_data(environ,
    ...
    # Get Minute or daily from command line
    typeOfData = input("Please enter Daily or Minute data: ")
    path.join(typeOfData)
    print("path is " + typeOfData)
...
def process_stocks(symbols, sessions, metadata, divs):
    ...
    for sid, symbol in enumerate(symbols):
        ...
        df0 = pd.read_csv('{}/{}.csv'.format(path, symbol), index_col=[1], parse_dates=[1]) 
